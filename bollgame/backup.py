...
def create_static_boundaries(space):
    static_lines = [
        pymunk.Segment(space.static_body, (130, 550), (660, 550), 20),  # 底辺
        pymunk.Segment(space.static_body, (140, 150), (140, 550), 20),  # 左の線
        pymunk.Segment(space.static_body, (650, 150), (650, 550), 20)   # 右の線
    ]
